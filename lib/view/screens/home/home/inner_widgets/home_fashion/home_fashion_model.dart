...
class HomeFashionModel {
  ...
  factory HomeFashionModel.fromRawJson(String str) => HomeFashionModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory HomeFashionModel.fromJson(Map<String, dynamic> json) => HomeFashionModel(
    id: json["id"],
